...
ENV S3_BUCKET="$S3_BUCKET" AWS_SECRET_ACCESS_KEY="$AWS_SECRET_ACCESS_KEY" AWS_ACCESS_KEY_ID="$AWS_ACCESS_KEY_ID"
ENV RAYGUN_API_KEY="$RAYGUN_API_KEY" AIRBRAKE_PROJECT_ID="$AIRBRAKE_PROJECT_ID" AIRBRAKE_PROJECT_KEY="$AIRBRAKE_PROJECT_KEY"
ENV DEVISE_SECRET_KEY="$DEVISE_SECRET_KEY" SENTRY_DSN="$SENTRY_DSN"
